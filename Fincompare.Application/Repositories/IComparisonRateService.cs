...
namespace Fincompare.Application.Repositories
{
    ...
    {
        Task<List<MarkupCalculationResult>> GetMerchantRatesFromTable(string sendCountry, string receiveCountry, string sendCur, string receiveCur, double sendAmount, double receiveAmount,int? productId, int? serviceCategoryId, int? instrumentId);
