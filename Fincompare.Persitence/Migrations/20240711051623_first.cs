        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Send_Cur = table.Column<int>(type: "integer", nullable: false),
                    Receive_Cur = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    City_Name = table.Column<string>(type: "character varying", maxLength: 40, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    State = table.Column<string>(type: "character varying", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Fees_Cur = table.Column<int>(type: "integer", nullable: false),
                    ...
                    Send_Country_3_iso = table.Column<string>(type: "character varying", nullable: false),
                    Receive_Country_3_iso = table.Column<string>(type: "character varying", nullable: false),
                    Send_Currency = table.Column<int>(type: "integer", nullable: false),
                    Receive_Currency = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Permissions",
                columns: new[] { "Id", "IsAdmin", "IsCustomer", "IsMerchant", "IsVendor", "PermissionName" },
                values: new object[,]
                {
                    { 10, true, false, false, false, "CanAccessAdmin" },
                    { 11, false, false, true, false, "CanAccessMerchant" },
                    { 12, false, false, false, true, "CanAccessVendor" },
                    { 13, false, true, false, false, "CanAccessCustomer" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Status",
                columns: new[] { "Id", "Description", "StatusCode" },
                values: new object[,]
                {
                    { 1, "Enabled", "EN" },
                    { 2, "Disabled", "DS" },
                    { 3, "Locked", "LK" },
                    { 4, "PasswordExpired", "PE" }
                });
